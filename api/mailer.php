<?php
/**
 * Funzioni di supporto per l'invio dell'email di conferma:
 * configurazione, controlli anti-abuso e spedizione via SMTP OVH.
 *
 * Questo file non risponde mai da solo: viene incluso da
 * send-confirmation.php e da diagnostica.php.
 */
...
/**
 * Carica config.php. Se manca, l'endpoint deve fallire in modo silenzioso:
 * l'utente ha comunque completato l'iscrizione tramite Web3Forms.
 *
 * @return array|null
 */
...
/**
 * Costruisce e spedisce l'email di conferma.
 *
 * @param array  $config
